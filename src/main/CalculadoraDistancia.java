...
public class CalculadoraDistancia {
	 ...
	 */
	public CalculadoraDistancia(int [][] matrizD1) {
	 ...
	 */
	public void calculaDistancia(int verticeOrigem, int verticeDestino) {
			...
			for (int linhaD1 = 0; linhaD1 < matrizD1.length; linhaD1++) {
				for (int colunaDn = 0; colunaDn < matrizD1.length; colunaDn++) {
					for (int colunaD1LinhaDn = 0; colunaD1LinhaDn < matrizD1.length; colunaD1LinhaDn++) {
						...
						//Se a soma do valor da D1 com o valor da matrizDiztanciaAnterior forem menores do que o que já está lá, substitui.
						if (matrizD1[linhaD1][colunaD1LinhaDn] + matrizDistanciaAnterior[colunaD1LinhaDn][colunaDn] < matrizDistancia[linhaD1][colunaDn]) {
							...
							//Se o valor mudou em relação à matriz anterior, coloca a o vértice que coincide nos dois números que somados formaram 
							//o valor da matrizDistancia nessa posição para montar a matriz de roteamento
